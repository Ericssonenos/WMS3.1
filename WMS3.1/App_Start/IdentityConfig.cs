...
namespace WMS3._1
{
    public class EmailService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            ...
            var Email = "ericsson.eno@hotmail.com";
            var Usuario = "ericsson.eno@hotmail.com";
            var Senha = "7474lb7474lb";
            ...
            var envio = new MailMessage(Email, message.Destination);
            envio.Subject = message.Subject;
            envio.Body = message.Body;
            envio.IsBodyHtml = true;

            return Cliente.SendMailAsync(envio); 
